                ...
                if df.empty:
                    ...
                    if purchase_price > 0:
                        ...
                        if current_price < purchase_price * 0.95 or current_price < stop_loss:
                            ...
                            hs_msg = "Stock aapke buy price ya technical support se kafi niche aa gaya hai. Nuksan aur badhne se pehle exit karna safe rahega."
                        elif pnl_percent > 10 and rsi > 70 and not is_macd_bullish:
                            hs_box = st.success
                            hs_title = "🟢 BOOK PROFIT (Sell)"
                            hs_msg = "Aapko accha profit ho raha hai aur indicators bata rahe hain ki stock gir sakta hai. Profit book kar lijiye."
                        elif "DOWNTREND" in trend_status:
                            hs_box = st.warning
                            hs_title = "🔴 SELL (Trend Reversed)"
                            hs_msg = "Market ka trend negative ho chuka hai. Isko hold karna risky ho sakta hai."
                        else:
                            hs_box = st.info
                            hs_title = "🟡 HOLD"
                    ...
                    with col_left:
                        ...
                        with st.expander("💡 Iska kya matlab hai?"):
                            ...
                            **Strong Buy:** Yeh price majboot support ke paas hai. Yahan risk sabse kam hota hai.\n
                            **Stop-Loss:** Agar price iske niche gir jaye, toh turant bech kar nikal jayein taaki bada nuksan (loss) na ho.
                            """)
